          ...
          <Grid container spacing={24}>
            ...
            <Grid item xs={12}>
              <RichTextBox
                ...
                onChange={this.onDescriptionRuChange}
                count
              />
            </Grid>
            <Grid item xs={12}>
              ...
              <Fab color="secondary" className="fab-add" aria-label="add" onClick={this.addRole}>
                <AddIcon />
              </Fab>
            </Grid>
            ...
            <Grid item xs={12}>
              ...
              <Link to="/projects" style={{ marginLeft: '30px' }}>
                <Button type="button" variant="outlined" className="decline-btn">
                  Отмена
                </Button>
              </Link>
            </Grid>
...
export default compose(withRouter)(CreateProject);
